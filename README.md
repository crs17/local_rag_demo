# Local RAG Agent
The purpose of this repo is to demonstrate how to build a basic local RAG agent. This could e.g. be used for making internal company documents "chatable".
...
- Finally, the [Agent Chat UI](https://docs.langchain.com/oss/python/langchain/ui) app is choosen as web UI.